...
这份计划从整体框架开始，逐步覆盖机器学习中的主要方法和模型。学习方式建议以“概念理解 + 可视化 + 代码实验 + 小项目”组合推进，而不是只看公式或只跑库函数。

## 1. 总体路线

```mermaid
flowchart TD
    A["数学与编程基础"] --> B["机器学习基本框架"]
    B --> C["监督学习"]
    B --> D["无监督学习"]
    C --> E["集成学习"]
    C --> F["深度学习"]
...
目标不是先把数学全部学完，而是先掌握机器学习够用的基础，然后在模型学习中不断回补。
